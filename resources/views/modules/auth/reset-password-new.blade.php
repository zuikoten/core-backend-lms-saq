...
<head>
    ...
    <title>Set Password Baru — SPP TK</title>
    ...
    <div class="w-full max-w-sm">
        <div class="bg-white rounded-2xl p-8" style="box-shadow: 0 2px 10px rgba(20,20,50,0.06);">
            <div class="flex flex-col items-center mb-6">
                ...
                <h1 class="text-lg font-semibold text-slate-800">Set Password Baru</h1>
                <p class="text-sm text-slate-500 mt-1 text-center">Kode OTP sudah terverifikasi. Silakan buat password baru.</p>
            </div>
            ...
            <form method="POST" action="{{ route('password.otp.new-password') }}" class="space-y-4">
                @csrf
