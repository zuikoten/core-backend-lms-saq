    ...
    <div class="w-full max-w-sm">
        <div class="bg-white rounded-2xl p-8" style="box-shadow: 0 2px 10px rgba(20,20,50,0.06);">
            <div class="flex flex-col items-center mb-6">
                ...
                <h1 class="text-lg font-semibold text-slate-800">Lupa Password (Email)</h1>
                <p class="text-sm text-slate-500 mt-1 text-center">Masukkan email akun kamu, kami kirim tautan reset.</p>
            </div>
